const todoInputElem = document.querySelector('.todo-insert');
const todoListElem = document.querySelector('.todo-list');
const completeAllBtnElem = document.querySelector('.completeallbtn');
...
const paintTodo = (todo) => {
    ...
    removeBtnElem.classList.add('removeBtn');
    removeBtnElem.addEventListener('click', () =>  deleteTodo(todo.id))
    removeBtnElem.innerHTML = 'X';
    ...
    todoItemElem.appendChild(removeBtnElem);
